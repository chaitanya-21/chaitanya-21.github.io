...
<body bgcolor="#f09970">
    ...
    <br>
    <h2>
        <center>Welcome&nbsp;<%=session.getAttribute("uname")%>
        </center>
    </h2>
    <br>
    <br>
    ...
    <%@ page import="java.sql.*" %>
        <% String pid=request.getParameter("pidd"); session.setAttribute("pid3",pid);
                        ...
                        <td>
                            <select name="phid">
                                <% Statement stmt=con.createStatement(); ResultSet rs=stmt.executeQuery("select * from
                                    pharmacy_details"); while(rs.next()) {out.println("<option>"+rs.getString(1));}
                                    %>
                            </select>
                    </tr>
                    <tr>
